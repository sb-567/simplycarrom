				...
				<div class="container-fluid">
					<div class="inner-body">
						...
						<div class="page-header">
							<div>
								<h2 class="main-content-title tx-24 mg-b-5">Attributes</h2>
								<ol class="breadcrumb">
							...
							<div class="d-flex">
								<div class="justify-content-center">
									...
									<a  class="btn btn-primary my-2 btn-icon-text" href="<?php echo base_url(); ?>Attributes/add">Add Attribute</a>
								</div>
							</div>
						...
						<div class="row row-sm">
								...
								<div class="card custom-card">
									<div class="card-body">
										<div>
											<h6 class="main-content-label mb-1">Attributes List</h6>
											<p class="text-muted card-sub-title">This are all Attributes you added</p>
										</div>
											...
											<table class="table" id="example2">
												...
												<tbody>
													...
													<tr>
														...
														<td>
																		<a href="<?php echo base_url(); ?>Attributes/delete/<?php echo $a['id']; ?>" class="btn btn-danger btn-sm">Delete</a>
																		<a href="<?php echo base_url(); ?>Attributes/edit/<?php echo $a['id']; ?>" class="btn btn-info btn-sm">Edit</a>
