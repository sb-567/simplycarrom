...
<html lang="en">
	...
	<body class="main-body leftmenu">
								...
								<div class="card custom-card">
									<div class="card-body">
										...
										<div class="table-responsive">
											<table class="table product" id="example2">
												<thead>
													<tr>
		...
		<script type="text/javascript">
			...
			oTable = $('.product').DataTable();   //pay attention to capital D, which is mandatory to retrieve "api" datatables' object, as @Lionel said
