					...
					<div class="inner-body">
						...
						<div class="page-header">
							...
							<div class="d-flex">
								<div class="justify-content-center">
									...
									<a  class="btn btn-primary my-2 btn-icon-text" href="<?php echo base_url(); ?>Faq/add">Add FAQ</a>
								</div>
							</div>
						...
						<div class="row row-sm">
								...
								<div class="card custom-card">
									<div class="card-body">
										<div>
											<h6 class="main-content-label mb-1">FAQ List</h6>
											<p class="text-muted card-sub-title">This are all FAQ you added</p>
										</div>
											...
											<table class="table" id="example1">
												...
												<tbody>
													...
													<tr>
														...
														<td>
																		<a href="<?php echo base_url(); ?>Faq/delete/<?php echo $f['id']; ?>" class="btn btn-danger btn-sm">Delete</a>
																		<a href="<?php echo base_url(); ?>Faq/edit/<?php echo $f['id']; ?>" class="btn btn-info btn-sm">Edit</a>
