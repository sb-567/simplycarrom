						...
						<div class="page-header">
							...
							<div class="d-flex">
								<div class="justify-content-center">
									...
									<a  class="btn btn-primary my-2 btn-icon-text" href="<?php echo base_url(); ?>System_users/add">Add User</a>
								</div>
							</div>
								...
								<div class="card custom-card">
									<div class="card-body">
										<div>
											...
											<p class="text-muted card-sub-title">This are all Users you added</p>
										</div>
											...
											<table class="table" id="example1">
												...
												<tbody>
													...
													<tr>
														...
														<td><?php echo $u['rights']; ?></td>
														<td>
																		<a href="<?php echo base_url(); ?>System_users/delete/<?php echo $u['id']; ?>" class="btn btn-danger btn-sm">Delete</a>
																		<a href="<?php echo base_url(); ?>System_users/edit/<?php echo $u['id']; ?>" class="btn btn-info btn-sm">Edit</a>
