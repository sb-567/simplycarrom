					...
					<div class="inner-body">
						...
						<div class="page-header">
							<div>
								...
								<ol class="breadcrumb">
									...
									<li class="breadcrumb-item active" aria-current="page">Blog details list</li>
								</ol>
							</div>
							<div class="d-flex">
								<div class="justify-content-center">
									...
									<a  class="btn btn-primary my-2 btn-icon-text" href="<?php echo base_url(); ?>Blog/add_blogs">Add Blog</a>
								</div>
							</div>
						...
						<div class="row row-sm">
								...
								<div class="card custom-card">
									<div class="card-body">
										<div>
											<h6 class="main-content-label mb-1">Blog details List</h6>
											<p class="text-muted card-sub-title">This are all Blog details you added</p>
										</div>
											...
											<table class="table" id="example1">
												...
												<tbody>
													...
													<tr>
														...
														<td>
																		<a href="<?php echo base_url(); ?>Blog/delete_blog/<?php echo $b['id']; ?>" class="btn btn-danger btn-sm">Delete</a>
																		<a href="<?php echo base_url(); ?>Blog/edit_blog/<?php echo $b['id']; ?>" class="btn btn-info btn-sm">Edit</a>
