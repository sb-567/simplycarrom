						...
						<div class="page-header">
							<div>
								...
								<ol class="breadcrumb">
									...
									<li class="breadcrumb-item active"  aria-current="page">Offer Edit</li>
								</ol>
							</div>
							<div class="d-flex">
										...
										<div class="card custom-card">
											<div class="card-body">
												<div class="row row-sm">
													...
													<div class="col-md-6">
														<div class="form-group">
															<p class="mg-b-10">Font Size</p>
															<input type="text" class="form-control " name="font_size" id="font_size" placeholder="Font Size"  value="<?php if(isset($offer)){ echo $offer['font_size'];} ?>">
														</div>
													</div>
