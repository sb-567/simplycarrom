					...
					<div class="inner-body">
						...
						<div class="page-header">
							...
							<div class="d-flex">
								<div class="justify-content-center">
									...
									<a  class="btn btn-primary my-2 btn-icon-text" href="<?php echo base_url(); ?>Promocode/add">Add Promo Code</a>
								</div>
							</div>
						...
						<div class="row row-sm">
								...
								<div class="card custom-card">
									<div class="card-body">
										<div>
											<h6 class="main-content-label mb-1">Promo Code List</h6>
											<p class="text-muted card-sub-title">This are all Codes you added</p>
										</div>
											...
											<table class="table" id="example1">
												...
												<tbody>
													...
													<tr>
														...
														<td><?php echo date("d F, Y",strtotime($p['start_date'])).' - '.date("d F, Y",strtotime($p['end_date'])); ?></td>
														<td>
																		<a href="<?php echo base_url(); ?>Promocode/delete/<?php echo $p['id']; ?>" class="btn btn-danger btn-sm">Delete</a>
																		<a href="<?php echo base_url(); ?>Promocode/edit/<?php echo $p['id']; ?>" class="btn btn-info btn-sm">Edit</a>
