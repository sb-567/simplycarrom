					...
					<div class="inner-body">
						...
						<div class="page-header">
							...
							<div class="d-flex">
								<div class="justify-content-center">
									...
									<a  class="btn btn-primary my-2 btn-icon-text" href="<?php echo base_url(); ?>Area/add_area">Add Area</a>
								</div>
							</div>
						...
						<div class="row row-sm">
								...
								<div class="card custom-card">
									<div class="card-body">
										<div>
											<h6 class="main-content-label mb-1">Area List</h6>
											<p class="text-muted card-sub-title">This are all Area you added</p>
										</div>
											...
											<table class="table" id="example1">
												<thead>
													<tr>
														...
														<th class="wd-25p">Area</th>
														<th class="wd-25p">Pincode</th>
														<th class="wd-25p">Del Charges</th>
												...
												<tbody>
													...
													<tr>
														...
														<td><?php echo $a['delivery_charges']; ?></td>
														<td>
															<a href="<?php echo base_url(); ?>Area/delete_area/<?php echo $a['id']; ?>" class="btn btn-danger btn-sm">Delete</a>
															<a href="<?php echo base_url(); ?>Area/edit_area/<?php echo $a['id']; ?>" class="btn btn-info btn-sm">Edit</a>
