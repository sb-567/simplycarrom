				...
				<div class="container-fluid">
					<div class="inner-body">
						...
						<div class="page-header">
							<div>
								<h2 class="main-content-title tx-24 mg-b-5">Taxes</h2>
								<ol class="breadcrumb">
									<li class="breadcrumb-item"><a href="<?php echo base_url(); ?>">Home</a></li>
									<li class="breadcrumb-item active" aria-current="page">Taxes list</li>
								</ol>
							</div>
							<div class="d-flex">
								<div class="justify-content-center">
									...
									<a  class="btn btn-primary my-2 btn-icon-text" href="<?php echo base_url(); ?>Taxes/add">Add Tax</a>
								</div>
							</div>
						...
						<div class="row row-sm">
								...
								<div class="card custom-card">
									<div class="card-body">
										<div>
											<h6 class="main-content-label mb-1">Tax List</h6>
											<p class="text-muted card-sub-title">This are all Tax you added</p>
										</div>
											...
											<table class="table" id="example1">
												<thead>
													<tr>
														...
														<th class="wd-25p">Percentage</th>
														<th class="wd-20p">Action</th>
													</tr>
												</thead>
												<tbody>
													<?php foreach($taxes as $a){ ?>
													<tr>
														<td><?php echo $a['id']; ?></td>
														<td><?php echo $a['tax_name']; ?></td>
														<td><?php echo $a['percentage']; ?></td>
														<td>
																		<a href="<?php echo base_url(); ?>Taxes/delete/<?php echo $a['id']; ?>" class="btn btn-danger btn-sm">Delete</a>
																		<a href="<?php echo base_url(); ?>Taxes/edit/<?php echo $a['id']; ?>" class="btn btn-info btn-sm">Edit</a>
