                                ...
                                <div class="single-product shop-page-product single-grid-product new-badge sale-badge">
                                    <div class="single-product-content">
                                        <div class="product-image">
                                            <a href="<?php echo base_url(); ?>Products/view/<?php echo $pbcat['slug']; ?>">
                                                <img src="<?php echo ADMINASSETS.$pbcat['image'] ?>" class="img-fluid" alt="">
                                                <img src="<?php echo ADMINASSETS.$pbcat['image'] ?>" class="img-fluid" alt="">
                                            </a>
                                            
                                        </div>
                                        <h5 class="product-name"><a href="<?php echo base_url(); ?>Products/view/<?php echo $pbcat['slug']; ?>"><?php echo $pbcat['name'] ?></a></h5>
                                        

                                        <a href="<?php echo base_url(); ?>Products/view/<?php echo $pbcat['slug']; ?>" class="add-to-cart-btn"> View Details</a>
                                    </div>
                                </div>
                                <!-- product end -->
                            </div>
