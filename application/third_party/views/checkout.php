                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-12 mb-40">
                                                        ...
                                                        <div class="checkout-cart-total">
                                                            ...
                                                            <p>CGST <span>₹ <?php echo $divgst ?></span></p>
                                                            <p>SGST <span>₹ <?php echo $divgst ?></span></p>
                                                            <p>Shipping Fee <span>Free</span></p>

                                                            <h4>Grand Total <span  id="final_value">₹ <?php echo $grand ?></span></h4>
                                                            <input type="hidden" name="final_value1" id="final_value1" value="<?php echo $grand ?>" >
                                                            <input type="hidden" name="grand_total" id="grand_total" value="<?php echo $grand; ?>" >
                                                      ...
                                                      <?php 
                                                            ...
                                                            foreach($user_cart_product as $cart){
                                                                $gst=$cart['percentage']/100;
                                                                    ...
                                                                    $subtotal_p=$sub_total_p-$with_p_gst;
                                                                    
                                                                    $sub_total_sp=$cart['sum_sp']*$cart['qty'];
                                                                    $with_sp_gst=$gst*$sub_total_sp;
                                                                    $subtotal_sp=$sub_total_sp-$with_sp_gst;
                                                    ...
                                                    <input type="hidden" name="total_sp[]" value=" <?php echo $value_cart_sp ?>"><br>
                                                <?php } ?>
                                                    ...
                                                    <div class="col-12 mb-40">
                                                        ...
                                                        <div class="promo-method">
                                                            ...
                                                            <input type="hidden" name="total_value[]" id="total_value-<?php echo $code["id"]; ?>" value="<?php echo $grand ?>" >
